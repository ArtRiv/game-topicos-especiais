...
- Mudar a perspectiva para **isométrica**: o GDD pede câmera isométrica. Phaser 3 não tem suporte nativo, então será necessário usar um plugin isométrico ou usar tiles rotacionados 45° simulando isometria
- Considerar adicionar tipo de física `matter` caso precise de colisões mais complexas com ângulos isométricos
...
- Atualmente: cria 1 player. Precisará criar **até 4 players**
...
### 3.5 Câmera
- Mudar de top-down para **isométrica**
- A câmera precisa acomodar até 4 jogadores ou ter lógica de split-screen/zoom dinâmico
...
- Remover sistema de corações estilo Zelda e substituir por barra de HP ou adaptar para 4 jogadores
